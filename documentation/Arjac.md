...
```
Mencionamos tambien la parte de Estadisticas, pero que tienen que ver con la inteligencia artificial? Mi objetivo va mas alla de ser un asistente virtual, quiero ser el primer sistema de Internet de las Cosas para Radioaficionados y Radio clubes, la parte de Big Data e Inteligencia Artifical no podran vivir separadas y esta combinacion hara que puedo yo actuar para hacer un mejor Radio Club y mejores Radio Aficionados
```
