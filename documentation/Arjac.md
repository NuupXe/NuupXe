...
```
Naci siendo Proyecto Cancun, era una estacion experimental que convertia texto a voz, despues aprendi a escuchar y decodificar palabras de audio en texto, sentando las bases para convertirme en un asistente virtual para cualquier radio aficionado y radio club
```
...
```
Mis conocimientos basicos incluyen identificarme, decir la hora, la fecha, el clima y la temperatura, que tal si recordamos como me escucho dandote estos servicios?
```
...
```
Control de Agendas? Al compartirme la agenda del radio club podre recordarte eventos o compartirtelos si me preguntas por ellos, dandote, por ejemplo, una respuesta asi: "Hola! Red semanal del Club de Radio Amateur del Estado de Guanajuato por el reflector 97 36 en 30 minutos"
```

```
Mencionamos tambien la parte de Estadisticas, pero que tienen que ver con la inteligencia artificial? Mi objetivo va mas alla de ser un asistente virtual, quiero ser el primer sistema de Internet de las Cosas en Repetidores para Radioaficionados y Radio clubes, la parte de Big Data e Inteligencia Artifical no podran vivir separadas y esta combinacion hara que puedo yo actuar para hacer un mejor Radio Club y mejores Radio Aficionados, pero como Nup Si, es decir yo, actuare para hacerte mejor? 
```

```
Podre decir cuanto tiempo se ha mantenido ocupado el repetidor, crear consursos de conocimientos, decirte chistes para que no te aburras, si no hay nadie mas quiza quieras conversar conmigo preguntandome sobre cosas de historia, tecnologia o hasta quieras saber la historia del radio club. 
```

```
Podre ser una calculadora para ayudarte con la propina que debes dejar, avisarte que me estoy quedando sin espacio en disco duro, que mi conexion a internet ha estado fallando, felicitar a cada uno de los miembros del radio club en su cumple, informarte sobre el estado de las bandas, estaciones
```
